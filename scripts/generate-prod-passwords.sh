...
sed -i '' "s/CONFIGPROXY_AUTH_TOKEN=.*/CONFIGPROXY_AUTH_TOKEN=$CONFIGPROXY_AUTH_TOKEN/" "$ENV_FILE"
sed -i '' "s/JUPYTERHUB_CRYPT_KEY=.*/JUPYTERHUB_CRYPT_KEY=$JUPYTERHUB_CRYPT_KEY/" "$ENV_FILE"
...
sed -i '' "s/GITEA_ADMIN_PASSWORD=.*/GITEA_ADMIN_PASSWORD=$GITEA_ADMIN_PASSWORD/" "$ENV_FILE"
sed -i '' "s/GITEA_DB_PASSWD=.*/GITEA_DB_PASSWD=$GITEA_DB_PASSWD/" "$ENV_FILE"
sed -i '' "s/LDAP_ADMIN_PASSWORD=.*/LDAP_ADMIN_PASSWORD=$LDAP_ADMIN_PASSWORD/" "$ENV_FILE"
sed -i '' "s/LDAP_CONFIG_PASSWORD=.*/LDAP_CONFIG_PASSWORD=$LDAP_CONFIG_PASSWORD/" "$ENV_FILE"
