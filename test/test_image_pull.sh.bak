...
if scripts/build.sh prod --pull --version v0.0.3.3 2>&1 | grep -q "拉取镜像需要指定 --registry 参数"; then
...
output=$(scripts/build.sh prod --registry test.com --pull --version v0.0.3.3 2>&1 || true)
...
echo ""
print_info "示例命令:"
echo "  scripts/build.sh prod --registry crpi-jl2i63tqhvx30nje.cn-chengdu.personal.cr.aliyuncs.com/ai-infra-matrix --pull --version v0.0.3.3"
