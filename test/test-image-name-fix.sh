...
test_cases=(
    ...
    "aiharbor.msxf.local/aihpc|ai-infra-backend:v0.3.5|aiharbor.msxf.local/aihpc/ai-infra-backend:v0.3.5|Harbor风格AI-Infra镜像"
    "registry.local:5000|postgres:15-alpine|registry.local:5000/postgres:15-alpine|传统风格基础镜像"
    "registry.local:5000|ai-infra-backend:v0.3.5|registry.local:5000/ai-infra/ai-infra-backend:v0.3.5|传统风格AI-Infra镜像"
