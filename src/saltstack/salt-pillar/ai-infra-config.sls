...
node_metrics:
  ...
  # - 外部 URL 格式: http://192.168.0.200:8080/api/saltstack/node-metrics/callback
  # 
  # 注意：Minion 在外部网络时无法解析 Docker 服务名（如 backend:8082）
  callback_url: "http://192.168.0.200:8080/api/saltstack/node-metrics/callback"
