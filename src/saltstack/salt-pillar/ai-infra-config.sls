...
# 
# 变量说明:
#   192.168.216.57    - 外部访问主机地址
#   80    - Nginx 主端口 (默认 8080)
...
node_metrics:
  ...
  # - 外部 URL 格式: https://192.168.216.57:80/api/saltstack/node-metrics/callback
  # 
  # 注意：Minion 在外部网络时无法解析 Docker 服务名（如 backend:8082）
  callback_url: "https://192.168.216.57:80/api/saltstack/node-metrics/callback"
