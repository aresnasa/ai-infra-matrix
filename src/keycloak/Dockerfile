...
FROM ${BASE_IMAGE_REGISTRY}quay.io/keycloak/keycloak:{{.KEYCLOAK_VERSION | default "26.0"}} AS builder
...
# ==================== 生产镜像 ====================
FROM ${BASE_IMAGE_REGISTRY}quay.io/keycloak/keycloak:{{.KEYCLOAK_VERSION | default "26.0"}}
