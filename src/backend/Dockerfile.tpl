...
RUN CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o sync-seaweedfs cmd/sync-seaweedfs/main.go
...
COPY --from=builder /go/src/github.com/aresnasa/ai-infra-matrix/src/backend/sync-seaweedfs .
