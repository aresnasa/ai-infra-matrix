...
func (ctl *KubernetesResourcesController) DeleteResource(c *gin.Context) {
    ...
    switch propagation {
    case "background": policy = metav1.DeletePropagationBackground
    case "orphan": policy = metav1.DeletePropagationOrphan
    default: policy = metav1.DeletePropagationForeground
    }
