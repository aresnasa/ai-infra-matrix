...
type ObjectStorageConfig struct {
	...
	Type        string    `json:"type" gorm:"not null;size:50"`                    // 存储类型：minio, aws_s3, aliyun_oss, tencent_cos
	Endpoint    string    `json:"endpoint" gorm:"not null;size:255"`               // 服务端点
	...
	WebURL      string    `json:"web_url" gorm:"size:255"`                         // Web控制台地址（MinIO等）
